...
var dateParsePatterns = [
    ...
    {   re: /^(\d{1,2})(?:st|nd|rd|th)? (\w+)$/i, 
        handler: function(bits) {
            var d = new Date();
            d.setMonth(parseMonth(bits[2]), parseInt(bits[1], 10));
            return d;
        }
    },
    // 4th Jan 2003
    ...
    {   re: /^(\w+) (\d{1,2})(?:st|nd|rd|th)?$/i, 
        handler: function(bits) {
            var d = new Date();
            d.setMonth(parseMonth(bits[1]), parseInt(bits[2], 10));
            return d;
        }
    },
    // Jan 4th 2003
    ...
    {   re: /(\d{1,2})\/(\d{1,2})\/(\d{4})/,
        handler: function(bits) {
            var d = new Date();
            d.setYear(bits[3]);
            d.setMonth(parseInt(bits[1], 10) - 1, parseInt(bits[2], 10)); // Because months indexed from 0
            return d;
        }
    },
    ...
    {   re: /(\d{4})-(\d{1,2})-(\d{1,2})/,
        handler: function(bits) {
            ...
            d.setMonth(parseInt(bits[2], 10) - 1, parseInt(bits[3], 10));
            return d;
        }
    },
    // mm/dd/yy
